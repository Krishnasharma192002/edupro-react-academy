      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Transform your career with our comprehensive online courses. Learn from industry experts and advance your skills.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center space-x-2">
                ...
                <span className="text-gray-400">info@edupro.com</span>
              </li>
              <li className="flex items-center space-x-2">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © 2024 EduPro. All rights reserved. Privacy Policy | Terms of Service
          </p>
        </div>
      </div>
    </footer>
